...
/* about us */
 ...
 /* end about us */         
    ...
    if ($this->form_validation->run() == FALSE) {
        ...
        $this->load->model("product_model");
        $data["transactions"] = $this->product_model->get_mpesa_transactions_by_user($this->input->post("user_id"));
        $data["response"] = true;
    }
...
public function mpesa_transaction_details() {
    $this->load->library('form_validation');
    ...
    if ($this->form_validation->run() == FALSE) {
        ...
        $this->load->model("product_model");
        $data["transaction_details"] = $this->product_model->get_mpesa_transaction_details($this->input->post("transaction_id"));
        $data["response"] = true;
    }
